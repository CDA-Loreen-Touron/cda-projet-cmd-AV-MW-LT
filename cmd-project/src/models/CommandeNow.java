...
public class CommandeNow extends Commande { // objet a zero ou un ou pl parametres
	...
	public void executer(String pParams) {
		...
		DateTimeFormatter dtfH = DateTimeFormatter.ofPattern("HH:mm:ss");// instancie et initialise les objets dates et
																			// heures
		...
		if (pParams.charAt(0) != '-') {
			...
			if (pParams.contains("-dt") || pParams.contains("-td") || pParams.contains("-t-d")
					|| pParams.contains("-d-t")) {
				pParams = "-dt";
			}
